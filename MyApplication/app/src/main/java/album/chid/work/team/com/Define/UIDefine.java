package album.chid.work.team.com.Define;
...
{
    // 字型定義，內容需同 BOPui_mlayout_templates 字型定義
    /**
     * 字型「4U」定義
     */
    ...
    public int m_MaxHeight = 0; //高度
    public int m_MaxWidth = 0; //寬度
    ...
    private void initial(Context context)
    {
        ...
        // 設定「長度、寬度單位」最大值
        m_iMaxLayoutHeightWeight = context.getResources().getInteger(R.integer.bop_ui_integer_activity_weight_sum_vertical);
        m_iMaxLayoutWidthWeight = context.getResources().getInteger(R.integer.bop_ui_integer_activity_weight_sum_vertical);
        ...
        m_MaxHeight = m_displayMetrics.heightPixels;
        m_MaxWidth = m_displayMetrics.widthPixels;
        ...
        m_fScreenScaleDensity = m_displayMetrics.scaledDensity;
    }
    ...
    /**
     * @param dWeight 高度比例，參數範圍為「1 ~ 100」
     * @return 取出經長寬比運算出的高度
     */
    ...
    /**
     * @param dWeight 寬度比例，參數範圍為「1 ~ 100」
     * @return 取出經長寬比運算出的寬度
     */
    ...
    /**
     * @param dTextSizeDefine 參數範圍為「{@link UIDefine#FontSize_10u FontSize_10u} ~
     *                        {@link UIDefine#FontSize_30u FontSize_30u}」
