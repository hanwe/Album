...
import album.chid.work.team.com.Compoment.CameraPreview;
...
//            barcode.setData(data);
            ...
            if (result != 0)
            {
                ...
                for (Symbol sym : syms)
                {
                    ...
                    intent.setClass(QRScan.this, PhotoPager.class);
                    ...
                    intent.putExtra("ScanInfo", "http://www.ilikeus.com.tw/static_file/ilikeus/zh_TW/album/4/20/4-20.zip");
